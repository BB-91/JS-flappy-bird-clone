"use strict";
import { TYPE, assertTypes, assertInstancesOf, getPropOrDefault,getNewElement, crash, assertHasKey, assertDoesNotHaveKey, assertIsArray, assertNotEmpty } from './Util.js';
...
class GameObj {
    ...
    constructor(dataObj) {
        ...
        // const tagName = getPropOrDefault(dataObj.tagName, TYPE.string, "sprite-rect");
