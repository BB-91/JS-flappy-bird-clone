...
class GameObj {
    ...
    constructor(dataObj) {
        ...
        this.#rect2 = getPropOrDefault(dataObj.rect2, Rect2, rect2(Vector2.ZERO, vector2(32, 32)));
    ...
    set setX(value) {
        ...
        // this.getElement.style.left = `${gameContainer.getBoundingClientRect().left + value}px`;
    }
    ...
    set setY(value) {
        ...
        // this.getElement.style.top = `${gameContainer.getBoundingClientRect().top + value}px`;
    }
